...
class OtaFromTargetFilesTest(test_utils.ReleaseToolsTestCase):
  ...
  def test_GetTargetFilesZipForSecondaryImages_dynamicPartitions(self):
    ...
    misc_info = '\n'.join([
        ...
        'dynamic_partition_list=system system_ext vendor vendor_dlkm product odm',
        'super_partition_groups=google_dynamic_partitions',
        'super_google_dynamic_partitions_group_size=4873781248',
        'super_google_dynamic_partitions_partition_list=system system_ext vendor vendor_dlkm product odm',
    ])
    ...
    expected_misc_info = misc_info.replace('system system_ext vendor vendor_dlkm product odm',
                                           'system')
    expected_dynamic_partitions_info = dynamic_partitions_info.replace(
        'system system_ext vendor vendor_dlkm product odm', 'system')
